...
/* Brand marks are filled glyphs, drawn on a shared 24px grid so the row reads
   as one set rather than five borrowed logos. */
const SOCIAL = [
  {
    label: "X",
    href: "https://x.com/cyphernaut",
  ...
  {
    label: "Discord",
    href: "https://discord.gg/cyphernaut",
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@cyphernaut",
